...
//SAPLogon760.events.START.once(function(ev) {
	var command = 'sapgui.exe /SHORTCUT="-gui="'+ rootData.SAPLogon760Data.pSAPData.IP +' ' + '01' +'" -SID='+ rootData.SAPLogon760Data.pSAPData.SID +' -client='+ rootData.SAPLogon760Data.pSAPData.ed集团 +' -user="'+ rootData.SAPLogon760Data.pSAPData.ed用户 +'" -pw="'+ rootData.SAPLogon760Data.pSAPData.o密码 +'" -l="zh" -reuse=1 -max -connid=zjmirpa';
